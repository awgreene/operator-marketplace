...
func main() {
	...
	flag.StringVar(&registry.RegistryServerImage, "registryServerImage",
		registry.DefaultRegistryServerImage, "the image to use for creating the operator registry pod")
	flag.Parse()
