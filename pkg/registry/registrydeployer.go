...
func NewRegistryDeployer(log *logrus.Entry, reader datastore.Reader, client client.Client) RegistryDeployer {
...
func (r *RegistryDeployer) CreateRegistryResources(csc *marketplace.CatalogSourceConfig) error {
...
func (r *RegistryDeployer) checkPackages(csc *marketplace.CatalogSourceConfig) error {
